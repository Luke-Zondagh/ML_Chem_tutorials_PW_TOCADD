...
def find_scaffolds(df_in, Name="Name", SMILES="SMILES", mol="mol"):
    """
...
def get_molecules_with_scaffold(scaffold, mol_df, activity_df, Name="Name",
                                 SMILES="SMILES", pIC50="pIC50", mol="mol"):
    """
